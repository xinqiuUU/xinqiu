...
@Service("账户支出")
public class OrderOutEmailContentServiceImpl implements EmailContentStrategyService{
    @Autowired
    private VelocityContext context;// 模板上下文
    @Autowired
    @Qualifier("orderOutTemplate") // 模板名称transferTemplate注入
