...
@LoadBalancerClients(
        value = {
                @LoadBalancerClient(name = "xin-product", configuration = MyLoadBalancerClientConfiguration.class),
                @LoadBalancerClient(name = "xin-security", configuration = MyLoadBalancerClientConfiguration.class)
